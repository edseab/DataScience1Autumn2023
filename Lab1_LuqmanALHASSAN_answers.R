...
# This is to test whether the denominator divides the dividend without a reminder
...
#For a uniform pdf bounded between 0 and 1, the probability density must always be greater or equal to 0 but can be greater than 1
