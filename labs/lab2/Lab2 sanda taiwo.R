...
prequel_matrix
row.names(prequel_matrix) <- c("The phantom menace", 
...
set.seed(123)
sims<- rbinom(1000000,20,0.7)
sum(sims<=11)
sum(sims<=11)/1000000
pbinom(11,20,0.7)
##11 sucess, 20 probes and 70%
...
my_t <- function(x1,x2){
 ...
 p_value= p1 +p2 
  #probability that you will get a test statistics that
...
##my own height percentile
pnorm(187, mean(men), sd(men))
