...
#to output the first two objects
...
# You can write several lines of code in a function by enclosing all of the in curly brackets {}. The function 'return' can then specify what the output can be. For example: you can also write functions for multiple objects...this code defines another variable 'z' as the reminder of y divided by x and returns the answer as boolean if it is not equal to 0
...
f2(8,9)
f2(14,7)
sum(ex.vector) / length(ex.vector)

### f2 tells us if one number is the multipke of the other number
...
### or you can define a function as my.mean and assign it to always give the sum of the object divided by the length
...
# For example, try....sampling 5 times, 5 numbers between 0and 1
runif(5,0,1)
###for the first element though it is still at ramdom
runif(5,0,1) [1]
runif(1,0,1)
### 4.3
...
### 4.5
# Similarly, what is the probability density for a uniform pdf bounded between 5 and 6 associated with all values of x between 5 and 6? The answer is 1

### 4.6
# What is the probability density for a uniform pdf bounded between 0 and 0.5 associated with all values of x between 0 and 0.5? The answer is 0.5 because the total area must be equaal to 1

### 4.7
# What is the probability density for a uniform pdf bounded between 0 and 2 associated with all values of x between 0 and 2?. The answer is 1
